        ...
        internal static void SendKeyboardInput(string keyCombination, int millisecondDelay)
        {
            ...
            try
            {
                foreach (string key in keys)
                {
                    ...
                    {
                        case "tab":
                            keysSequence.Add(Key.Tab);
                            break;
                        case "enter":
                            keysSequence.Add(Key.Enter);
                            break;
                        case "space":
                        ...
                        case "*":
                            ...
                            break;
                        case "down":
                            keysSequence.Add(Key.Down);
                            break;
                        case "up":
                            keysSequence.Add(Key.Up);
                            break;
                        case "left":
                            keysSequence.Add(Key.Left);
                            break;
                        case "right":
                            keysSequence.Add(Key.Right);
                            break;
                        default:
